(()=>{
  function init(){
    ...
    if(use&&!document.getElementById('scenario')){
      ...
      use.insertAdjacentHTML('afterend',`<section class="chapter scenario-chapter" id="scenario"><div class="shell chapter-inner"><div class="chapter-divider"><span class="chapter-num">04</span><span class="chapter-line"></span><span class="chapter-label">真实场景</span></div><div class="chapter-head"><h2>把地图用在真实工作里</h2><p>真实应用 · 统一标准 · 持续演进</p></div><div class="scenario-grid"><a class="scenario-feature" href="scenario-seekalpha.html" aria-label="查看 SeekAlpha 市场研究与决策完整案例"><div class="scenario-feature-copy"><div class="scenario-feature-eyebrow">真实场景 001</div><div class="scenario-feature-status">真实应用 · Genesis 平台化演进中</div><h3>SeekAlpha 市场研究与决策</h3><div class="scenario-feature-question">今天哪些方向值得重点关注 为什么</div><p>把市场数据、事件和专业方法组织成持续可验证的市场判断，并逐步迁移到 Genesis 统一的数据、语义、能力和证据链。</p><div class="scenario-feature-tags"><span>业务本体</span><span>数据治理</span><span>专业方法</span><span>真实应用</span><span>持续闭环</span></div><div class="scenario-feature-link">查看完整案例 →</div></div><div class="scenario-feature-visual"><div class="scenario-evidence-board"><div class="scenario-evidence-title">已核实证据</div><div class="scenario-evidence-sub">只放有固定来源和日期的真实数字</div><div class="scenario-evidence-grid"><div class="scenario-evidence-metric"><b>253 / 253</b><span>符合条件的权益 ETF 覆盖</span></div><div class="scenario-evidence-metric"><b>2,069</b><span>基金日行情记录</span></div><div class="scenario-evidence-metric"><b>7</b><span>当前真实小程序页面</span></div><div class="scenario-evidence-metric"><b>7</b><span>市场情报输入数据合同</span></div></div><div class="scenario-feature-proof"><span>3 类数据合同可用</span><span>2 类部分可用</span><span>2 类暂不可用</span></div><div class="scenario-evidence-foot">数据快照：2026-07-24 预发布环境 · 合同状态：2026-09-02</div></div></div></a><a class="scenario-feature" href="scenario-intelligent-ops.html" aria-label="查看智能运维巡检完整案例"><div class="scenario-feature-copy"><div class="scenario-feature-eyebrow">真实场景 002</div><div class="scenario-feature-status">真实开发环境验证 · 完整试点进行中</div><h3>智能运维巡检</h3><div class="scenario-feature-question">这个环境现在健康吗 哪些风险值得关注</div><p>用已实现的运维本体、受控数据绑定、可信事实和确定性巡检策略，把真实遥测数据变成有证据的风险判断和巡检报告。</p><div class="scenario-feature-tags"><span>运维本体</span><span>数据治理</span><span>确定性判断</span><span>证据巡检</span><span>持续闭环</span></div><div class="scenario-feature-link">查看完整案例 →</div></div><div class="scenario-feature-visual"><div class="scenario-evidence-board"><div class="scenario-evidence-title">已核实证据</div><div class="scenario-evidence-sub">真实观测源与开发环境采样</div><div class="scenario-evidence-grid"><div class="scenario-evidence-metric"><b>58</b><span>真实指标测量类型</span></div><div class="scenario-evidence-metric"><b>2</b><span>真实日志索引</span></div><div class="scenario-evidence-metric"><b>11</b><span>已实现运维事实类型</span></div><div class="scenario-evidence-metric"><b>18</b><span>领域包受控只读能力</span></div></div><div class="scenario-feature-proof"><span>主机采样 50 条观测</span><span>服务采样 22 条观测</span><span>完整试点未完成</span></div><div class="scenario-evidence-foot">数据能力基线：2026-08-30 · 采样观测数不是主机或服务总数</div></div></div></a></div></div></section>`);
    }
